        ...
        <div class="shadow p-5 mb-5 bg-white rounded">
            ...
            @if ($order)
                {{-- <div class="customer-info p-4 mb-4 bg-light rounded">
                    <form action="{{ route('employee.confirmorder', ['id' => $order->id]) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="hidden" name="order_detail_id" id="order_detail_id"
                                    value="{{ json_encode($list_order_detail_id) }}">
                                <button class="btn btn-danger" type="submit">ยืนยันการเพิ่มออเดอร์</button>
                            </div>
                    </form>
