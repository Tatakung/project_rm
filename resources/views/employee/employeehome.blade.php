    ...
    <div class="container py-2">
        ...
        <div class="row mb-5">
            <div class="col-12 text-center">
                <h2 class="mb-2">สวัสดี, คุณ{{ $employee->name }} {{ $employee->lname }}</h2>
                <p class="text-muted fs-5">
                    {{ \Carbon\Carbon::parse($time)->locale('th')->isoFormat('D MMM') }}
                    {{ \Carbon\Carbon::parse($time)->year + 543 }}
                </p>
                <p class="text-muted fs-5">
                    วันนี้ฉันควรจะทำอะไรดี
                </p>
            </div>
        </div>
                ...
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="card-title mb-0">งานตัดที่รอดำเนินการ</h5>
                        </div>
                        <div class="ps-4">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="card-title mb-0">ชุดที่รอดำเนินการซัก</h5>
                        </div>
                        <div class="ps-4">
                        ...
                        <div class="ps-4">
                            @if ($repair->count() > 0)
                                @foreach ($repair as $item)
                                    @php
                                        $near_dress_repair = App\Models\Reservation::whereNot('id',$item->reservation_id)
