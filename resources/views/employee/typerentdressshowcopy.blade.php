...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('employee.selectdatesuccess',['startDate' =>$selectstartDate , 'endDate' => $selectendDate , '$totalDay' => $selecttotalDay  ])}}">เลือกหมวดหมู่ชุด</a></li>
        <li class="breadcrumb-item active">หมวดหมู่{{$type_dress_name->type_dress_name}}</li>
    </ol>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="dress{{ $item->id }}"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if ($check_separable == 1)

                                                        @php
                                                            $maxdress_no = App\Models\Dressmeasurementnow::where(
                                                                'dress_id',
                                                                $item->id,
                                                            )->max('count');
                                                        @endphp
                                                        @foreach (App\Models\Dressmeasurementnow::where('dress_id', $item->id)->where('count', $maxdress_no)->get() as $measument_no_separate_now)
                                                    ...
                                                    @else
                                                        {{-- ส่วนเสื้อ --}}
                                                        @php
                                                            $shirt_id = App\Models\Shirtitem::where(
                                                                'dress_id',
                                                                $item->id,
                                                            )->value('id');

                                                            $max_shirt = App\Models\Dressmeasurementnow::where(
                                                                'shirtitems_id',
                                                                $shirt_id,
                                                            )->max('count');
                                                        @endphp

                                                        @foreach (App\Models\Dressmeasurementnow::where('shirtitems_id', $shirt_id)->where('count', $max_shirt)->get() as $mea_shirt_yes_separate_now)
                                                            {{ $mea_shirt_yes_separate_now->measurementnow_dress_name }}&nbsp;{{ $mea_shirt_yes_separate_now->measurementnow_dress_number }}&nbsp;{{ $mea_shirt_yes_separate_now->measurementnow_dress_unit }}
                                                        @endforeach
                                                        {{-- ส่วนกระโปรง --}}

                                                        @php
                                                            $skirt_id = App\Models\Skirtitem::where(
                                                                'dress_id',
                                                                $item->id,
                                                            )->value('id');

                                                            $max_skirt = App\Models\Dressmeasurementnow::where(
                                                                'skirtitems_id',
                                                                $skirt_id,
                                                            )->max('count');
                                                        @endphp

                                                        @foreach (App\Models\Dressmeasurementnow::where('skirtitems_id', $skirt_id)->where('count', $max_skirt)->get() as $mea_skirt_yes_separate_now)
                                                            {{ $mea_skirt_yes_separate_now->measurementnow_dress_name }}&nbsp;{{ $mea_skirt_yes_separate_now->measurementnow_dress_number }}&nbsp;{{ $mea_skirt_yes_separate_now->measurementnow_dress_unit }}
                                                        @endforeach
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <form action="{{ route('employee.addrentdresscart') }}"
                                                        ...
                                                        @php
                                                            $maxdress_no_yes = App\Models\Dressmeasurementnow::where(
                                                                'dress_id',
                                                                $item->id,
                                                            )->max('count');
                                                        @endphp
                                                        @foreach (App\Models\Dressmeasurementnow::where('dress_id', $item->id)->where('count', $maxdress_no_yes)->get() as $measument_no_yes_separate_now)
                                                            <input type="hidden" name="mea_shirt_now_[]"
                                                                value="{{ $measument_no_yes_separate_now->shirtitems_id }}">
                                                            <input type="hidden" name="mea_skirt_now_[]"
                                                                value="{{ $measument_no_yes_separate_now->skirtitems_id }}">
                                                            <input type="hidden"
                                                                value="{{ $measument_no_yes_separate_now->measurementnow_dress_name }}"
                                                                name="mea_now_dress_name_[]">
                                                            <input type="hidden"
                                                                value="{{ $measument_no_yes_separate_now->measurementnow_dress_number }}"
                                                                name="mea_now_dress_number_[]">
                                                            <input type="hidden"
                                                                value="{{ $measument_no_yes_separate_now->measurementnow_dress_unit }}"
                                                                name="mea_now_dress_unit_[]">
                                                            <input type="hidden"
                                                                value="{{ $measument_no_yes_separate_now->measurementnow_dress_number_start }}"
                                                                name="mea_now_dress_number_start_[]">
                                                        @endforeach
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @php
                                                        $maxdress_shirt = App\Models\Dressmeasurementnow::where(
                                                            'shirtitems_id',
                                                            App\Models\Shirtitem::where('dress_id', $item->id)->value(
                                                                'id',
                                                            ),
                                                        )->max('count');
                                                    @endphp
                                                    @foreach (App\Models\Dressmeasurementnow::where('shirtitems_id', App\Models\Shirtitem::where('dress_id', $item->id)->value('id'))->where('count', $maxdress_shirt)->get() as $measument_yes_separate_now_shirt)
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    @if ($item->separable == 2)
                                                        <form action="{{ route('employee.addrentdresscart') }}"
                                                            ...
                                                            @foreach (App\Models\Dressmeasurementnow::where('shirtitems_id', App\Models\Shirtitem::where('dress_id', $item->id)->value('id'))->where('count', $maxdress_shirt)->get() as $measument_yes_separate_now_shirt)
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_shirt->measurementnow_dress_name }}"
                                                                    name="mea_now_dress_name_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_shirt->measurementnow_dress_number }}"
                                                                    name="mea_now_dress_number_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_shirt->measurementnow_dress_unit }}"
                                                                    name="mea_now_dress_unit_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_shirt->measurementnow_dress_number_start }}"
                                                                    name="mea_now_dress_number_start_[]">
                                                            @endforeach
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @php
                                                        $maxdress_skirt = App\Models\Dressmeasurementnow::where(
                                                            'skirtitems_id',
                                                            App\Models\Skirtitem::where('dress_id', $item->id)->value(
                                                                'id',
                                                            ),
                                                        )->max('count');
                                                    @endphp
                                                    @foreach (App\Models\Dressmeasurementnow::where('skirtitems_id', App\Models\Skirtitem::where('dress_id', $item->id)->value('id'))->where('count', $maxdress_skirt)->get() as $measument_yes_separate_now_skirt)
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    @if ($item->separable == 2)
                                                        <form action="{{ route('employee.addrentdresscart') }}"
                                                            ...
                                                            @foreach (App\Models\Dressmeasurementnow::where('skirtitems_id', App\Models\Skirtitem::where('dress_id', $item->id)->value('id'))->where('count', $maxdress_skirt)->get() as $measument_yes_separate_now_skirt)
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_skirt->measurementnow_dress_name }}"
                                                                    name="mea_now_dress_name_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_skirt->measurementnow_dress_number }}"
                                                                    name="mea_now_dress_number_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_skirt->measurementnow_dress_unit }}"
                                                                    name="mea_now_dress_unit_[]">
                                                                <input type="hidden"
                                                                    value="{{ $measument_yes_separate_now_skirt->measurementnow_dress_number_start }}"
                                                                    name="mea_now_dress_number_start_[]">
                                                            @endforeach
