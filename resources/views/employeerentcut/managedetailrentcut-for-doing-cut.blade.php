    ...
    <div class="container mt-4">
        ...
        <div class="row mt-3 d-flex align-items-stretch">
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-body">
                        <h5 class="card-title">ข้อมูลการเช่าตัดชุด</h5>
                        @php
                        ...
                        <p><i class="bi bi-currency-dollar"></i> ราคาเช่าตัดชุด (บาท) :
                        ...
                        <p><i class="bi bi-currency-dollar"></i> ประกันชุด (บาท) :
                                ...
                                @foreach ($fitting as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                style="display: none ; " @endif>
                                                <i class="bi bi-check-circle"></i> ทำรายการ
                                            </a>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content shadow-lg">
                                                    ...
                                                    @if ($mea_adjust_to_fitting->isNotEmpty())
                                                        <div class="px-4 pt-3">
                                                            <h6 class="text-secondary mb-2">รายการข้อมูลการวัดที่ปรับ</h6>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label
                                                                class="font-weight-bold text-secondary mb-2">รายละเอียดสำหรับลองชุด</label>
                                                        ...
                                                        @if ($Have_Extra->isNotEmpty())
                                                            <div class="mt-4">
                                                                <h6 class="text-secondary mb-3">รายการเพิ่มเติมพิเศษ</h6>
