                    ...
                    <div class="alert alert-danger" role="alert">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if ($check_cut_dress_success == true)
                                    <p class="mb-0">
                                        <strong>รายการนี้ถูกยกเลิกรายการเช่าตัด{{ $orderdetail->type_dress }}โดยทางร้าน

                                        </strong>
                                    </p>
                                @elseif($check_cut_dress_success == false)
                                    <p class="mb-0">
                                        <strong>รายการนี้ถูกยกเลิกรายการเช่าตัด{{ $orderdetail->type_dress }}โดยทางร้าน
                                            กรุณาตัดชุดให้เสร็จและเพิ่มชุดที่ตัดเข้าสู่ระบบต่อไปสำหรับให้เช่าในอนาคต
                                        </strong>
                                    </p>
                                @endif
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right"
                                @if ($orderdetail->status_detail == 'ยกเลิกโดยลูกค้า' || $orderdetail->status_detail == 'ยกเลิกโดยทางร้าน') @if ($check_cancel == true)
                                        @if ($check_cut_dress_success == false)
                                        style="display: block;" 
                                        @elseif($check_cut_dress_success == true)
                            ...
                            @else
                                ...
                                @if (in_array('ตัดชุดเสร็จสิ้น', $list_status))
                                    ...
                                    <div class="status-step text-center">
                                        ...
                                        <p>
                                            <a
                                                href="{{ route('employee.ordertotaldetailshow', ['id' => $orderdetail->id]) }}">ดูรายการเช่า</a>
                                        </p>
                                        <small>
                                            <p>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-toggle="modal"
                                        ...
                                        @if ($check_button_add_fitting_image) style="display: none ; "
                                        @else
                                    ...
                                    @foreach ($fitting as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div
                                                    @if ($item->fitting_status == 'มาลองชุดแล้ว') style="display: block ; "
                            @else
                                style="display: none ; " @endif>
                                                    <button type="button"
                            ...
                            @else
                                style="display: none ; " @endif>
                                    ...
                                    style="display: none ; " @endif>
                                            ...
                                            <div class="modal fade" id="modalfitting_show{{ $item->id }}"
                                                tabindex="-1" aria-hidden="true" data-backdrop="static">
                                                <div class="modal-dialog modal-lg">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{ route('employee.savecutdressaddimage', ['id' => $orderdetail->id]) }}"
                        ...
                        <div class="modal-footer">
                            <button class="btn" style="background-color:#DADAE3;" type="button"
                                data-dismiss="modal">ยกเลิก</button>
