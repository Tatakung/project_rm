...
@section('content')
    ...
    <div class="container">
        <div class="card">
            ...
            <p>dress_id:{{ $orderdetail->dress_id }}</p>
            <p>shirt_id : {{ $orderdetail->shirtitems_id }}</p>
            <p>skirt_id : {{ $orderdetail->skirtitems_id }}</p> --}}
            ...
            @endphp
            {{-- <p>คิวแรกผลลัพธ์คือ : {{$reservation_now->id}}</p>
            {{$check_open_button}} --}}
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="info-box">
                            ...
                            <script>
                                ...
                                document.getElementById('showday').innerHTML = '(อีก ' + totalday + ' วัน)';
                            </script>
                            ...
                            <p><strong>สถานะจ่ายเงิน:</strong> <span style="color: #000000">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 justify-content-end"
                                @if ($check_button_updatestatusadjust == true && $check_open_button == true) 
                                    style="display: block;" 
                                @else
                                    style="display: none ; "
                                @endif>
                            ...
                            @foreach ($dress_mea_adjust as $index => $dress_mea_adjust)
                                <tr>
                                    ...
                                    <th>{{ $dress_mea->mea_dress_name }}
                                        <span style="font-size: 14px; color: rgb(140, 35, 35) ; ">
                                            @php
