            ...
            <div class="col-md-5">
                ...
                <ul>
                    <li>สถานะ {{ $typedress->type_dress_name }} {{ $typedress->specific_letter }}{{ $dress->dress_code }}
                        (เสื้อ) ปัจจุบัน : {{ $dress->shirtitems->first()->shirtitem_status }}</li>
...
<ul>
    <li>
        <strong>เงื่อนไขที่ 1 (ช่วงก่อนวันนัดรับใหม่):</strong> ระบบจะตรวจสอบ 7 วันก่อนวันนัดรับใหม่ว่าชุดไม่ติดการจองหรือการเช่าของลูกค้าท่านอื่น
    </li>
    <li>
        <strong>เงื่อนไขที่ 2 (ช่วงวันนัดรับใหม่ถึงวันนัดคืนใหม่):</strong> ระบบจะตรวจสอบว่าในช่วงวันที่ต้องการเลื่อนไปใช้บริการนั้น ชุดไม่ติดการจองหรือการเช่าของลูกค้าท่านอื่น
    </li>
    <li>
        <strong>เงื่อนไขที่ 3 (ช่วงหลังวันนัดคืนใหม่):</strong> ระบบจะตรวจสอบ 7 วันหลังวันนัดคืนใหม่ว่าชุดไม่ติดการจองหรือการเช่าของลูกค้าท่านอื่น
    </li>
</ul>
<p>
    <strong>หมายเหตุ:</strong> การเลื่อนวันนัดรับ-นัดคืนจะสามารถทำได้ก็ต่อเมื่อผ่านทั้ง 3 เงื่อนไขข้างต้น เพื่อให้มั่นใจว่ามีช่วงเวลาเพียงพอสำหรับการเตรียมชุดก่อนส่งมอบและการจัดการหลังคืนชุด โดยไม่กระทบต่อการจองของลูกค้าท่านอื่น
</p>
