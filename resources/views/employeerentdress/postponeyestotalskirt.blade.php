        ...
        <div class="row mt-5 mb-5">
            <div class="col-md-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <p>เช่า{{ $typedress->type_dress_name }} {{ $dress->dress_code_new }}{{ $dress->dress_code }} (ผ้าถุง)</p>
                        ...
                        <form action="{{ route('employee.ordertotaldetailpostponecheckeddressskirt', ['id' => $orderdetail->id]) }}"
                            method="GET">
                            @csrf
