    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12" style="text-align: center ;">
                ...
                <p>{{ $typedress->type_dress_name }} {{ $dress->dress_code_new }}{{ $dress->dress_code }} (ผ้าถุง)</p>
                                ...
                                @foreach ($reservation_dress_skirt as $reservation)
                                    {
                                        ...
                                        title:
                                            ...
                                            '{{ \Carbon\Carbon::parse($reservation->end_date)->addDay()->format('Y-m-d') }}',
                                            color: '#3788d8' // สีน้ำเงินสำหรับเช่าเฉพาะผ้าถุง
                                    },
                                @endforeach
            ...
            <div class="col-md-5">
                ...
                <ul>
                    <li>สถานะ {{ $typedress->type_dress_name }} {{ $typedress->specific_letter }}{{ $dress->dress_code }}
                        (ผ้าถุง) ปัจจุบัน : {{ $dress->skirtitems->first()->skirtitem_status }}</li>
                </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form
                            action="{{ route('employee.ordertotaldetailpostponecheckeddressskirt', ['id' => $orderdetail->id]) }}"
                            method="GET">
                            @csrf
