...
@section('content')
    ...
    <div class="container-fluid p-4">
        <div class="card shadow-lg">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0">แดชบอร์ดสำหรับเช่าเครื่องประดับ</h3>
                <div class="d-flex">
            ...
            <div class="card-body">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card shadow-sm h-100">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">รายได้แยกตามประเภทเครื่องประดับ</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm h-100">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">อันดับเครื่องประดับยอดนิยม</h5>
                            </div>
                            <div class="card-body">
                                <div class="list-group">
                                    <div
                                        ...
                                        <div>
                                            <h6 class="mb-1">กำไล</h6>
                                            <small class="text-muted">10 ครั้ง</small>
                                        </div>
                                    ...
                                    <div
                                        class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1">สร้อย</h6>
                                            <small class="text-muted">9 ครั้ง</small>
                                        </div>
                                    ...
                                    <div
                                        class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1">เข็มกลัด</h6>
                                            <small class="text-muted">7 ครั้ง</small>
                                        </div>
    ...
    var revenueByTypeData = {
        labels: ['กำไล', 'สร้อย', 'เข็มกลัด', 'สังวาล'],
        datasets: [{
            data: [2300, 2600, 2400, 1400],
            backgroundColor: [
