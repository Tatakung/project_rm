...
<ol class="breadcrumb" style="background-color: transparent;">
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5">
                <h2 class="card-title">ลำดับคิวเช่า</h2>
                @foreach ($jewelrysetitem as $item)
                <ul>
                    <li>สถานะเซต {{ $item->jewitem_m_to_o_jew->jewelry_m_o_typejew->type_jewelry_name }}{{ $item->jewitem_m_to_o_jew->jewelry_m_o_typejew->specific_letter }}{{$item->jewitem_m_to_o_jew->jewelry_code}} ปัจุจุบัน : {{$item->jewitem_m_to_o_jew->jewelry_status}}</li>
                </ul>          
                @endforeach
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form action="{{ route('postponeroutejewelrycheckedyesset', ['id' => $reser->id]) }}"
                            method="GET">
                            @csrf
