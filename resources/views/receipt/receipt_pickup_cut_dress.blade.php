        ...
        <tbody>
            ...
            @if ($only_payment == true)
                <tr>
                    ...
                    <td>ค่าตัด{{ $orderdetail->type_dress }}
                    </td>
                ...
                <tr>
                    <td class="text-center" style="vertical-align: top;">{{ $count_index++ }}</td>
                    <td>มัดจำตัด{{ $orderdetail->type_dress }}
                        <span style="color: rgb(133, 126, 126) ; font-size: 17px; ">(ชำระเมื่อ
                            ...
                            {{ \Carbon\Carbon::parse($orderdetail->created_at)->year + 543 }})</span>
                    </td>
                    <td class="text-center" style="vertical-align: top;">1</td>
                    <td class="text-center" style="vertical-align: top;">
                        {{ number_format($orderdetail->deposit, 2) }}</td>
                    <td class="text-center" style="vertical-align: top;">
                        {{ number_format($orderdetail->deposit, 2) }} <br>
                    </td>
                </tr>
